...
async def _get_conversation_info(
    ...
    try:
        ...
        # Calculate the host conversation path
        base_workspace_path = config.workspace_base or './workspace'
        host_conversation_path = (
            Path(base_workspace_path).resolve() / conversation.conversation_id
        )
        ...
        return ConversationInfo(
            ...
            host_conversation_path=host_conversation_path_str,  # Added path
        )
    except Exception as e:
        logger.error(
